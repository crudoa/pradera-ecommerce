...
import { SearchBar } from "@/components/ui/search-bar" // Declare the SearchBar variable
          ...
          <AuthProvider>
            <CartProvider>
              <FavoritesProvider>
                ...
                <main className="flex-grow">{children}</main> {/* Added flex-grow for layout */}
                <Footer />
...
function Header() {
  ...
  const { user, signOut, isAuthenticated } = useAuth() // Destructure isAuthenticated
    ...
    <header className="bg-white shadow-sm border-b sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          {/* Search Bar - Desktop */}
          <div className="hidden md:flex flex-1 max-w-md mx-8" suppressHydrationWarning>
