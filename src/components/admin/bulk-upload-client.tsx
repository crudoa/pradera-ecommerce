...
export function BulkUploadClient({ initialCategories }: BulkUploadClientProps) {
  ...
  // Categories state (used by both forms) - now initialized from props
  const [categories] = useState<Category[]>(initialCategories)
  const [loadingCategories, setLoadingCategories] = useState(false) // This was true in previous turn, but categories are passed as props now.
            ...
            <Card>
              ...
              <CardContent>
                ...
                >
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-short-description">Descripción Corta</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="grid gap-2">
                      <Label htmlFor="new-product-price">Precio (S/)</Label>
                      <Input
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor="new-product-original-price">Precio Original (S/)</Label>
                      <Input
                      ...
                      {getZodErrorMessage(newProductErrors, "original_price") && (
                        <p className="text-red-500 text-sm">{getZodErrorMessage(newProductErrors, "original_price")}</p>
                      )}
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    {getZodErrorMessage(newProductErrors, "stock_quantity") && (
                      <p className="text-red-500 text-sm">{getZodErrorMessage(newProductErrors, "stock_quantity")}</p>
                    )}
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-weight">Peso (kg)</Label>
                    <Input
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-dimensions">Dimensiones (JSON)</Label>
                    <Input
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-specifications">Especificaciones (JSON)</Label>
                    <Input
                    ...
                    {getZodErrorMessage(newProductErrors, "specifications") && (
                      <p className="text-red-500 text-sm">{getZodErrorMessage(newProductErrors, "specifications")}</p>
                    )}
                  </div>
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-image-url">URL Imagen</Label>
                    <Input
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="grid gap-2">
                      <Label htmlFor="new-product-view-count">Vistas</Label>
                      <Input
                    ...
                    <div className="grid gap-2">
                      <Label htmlFor="new-product-sales-count">Ventas</Label>
                      <Input
                      ...
                      {getZodErrorMessage(newProductErrors, "sales_count") && (
                        <p className="text-red-500 text-sm">{getZodErrorMessage(newProductErrors, "sales_count")}</p>
                      )}
                    </div>
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-rating">Calificación</Label>
                    <Input
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-meta-title">Meta Título</Label>
                    <Input
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-meta-description">Meta Descripción</Label>
                    <Textarea
                    ...
                    {getZodErrorMessage(newProductErrors, "meta_description") && (
                      <p className="text-red-500 text-sm">{getZodErrorMessage(newProductErrors, "meta_description")}</p>
                    )}
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-tags">Etiquetas (separadas por coma)</Label>
                    <Input
                      id="new-product-tags"
                      name="tags"
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="new-product-brand-id">ID de Marca</Label>
                    <Input
